			...
			<div class="col-md-10">
				...
				<c:forEach items="${hotProducts}" var="pro">
					<div class="col-md-2"
						...
						<p>
							<a href="product_info.html" style='color: #666'>${pro.pname}</a>
						</p>
						<p>
			...
			<div class="col-md-10">
				...
				<c:forEach items="${newProducts}" var="newPro">
					<div class="col-md-2"
						style="text-align: center; height: 200px; padding: 10px 0px;">
						<a href="product_info.htm"> <img
							src="${pageContext.request.contextPath}/${newPro.pimage}" width="130" height="130"
							style="display: inline-block;">
						</a>
						<p>
							<a href="product_info.html" style='color: #666'>${newPro.pname}</a>
						</p>
						<p>
							<font color="#E4393C" style="font-size: 16px">&yen;${newPro.shop_price}</font>
						</p>
					</div>
				</c:forEach>
			</div>
